...
if __name__ == "__main__":
    ...
    for _ in range(200):
        ...
        master_processor.lazy_push_T(T1)
        master_processor.lazy_push_T(T2)
        master_processor.lazy_push_T(T3)
        master_processor.lazy_push_T(T4)
        master_processor.lazy_push_T(T_err)
    time.sleep(4)